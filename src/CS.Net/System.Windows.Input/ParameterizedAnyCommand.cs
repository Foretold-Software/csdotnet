...
namespace System.Windows.Input
{
	...
	/// </summary>
	public class ParameterizedAnyCommand : ParameterizedMultiCommand, ICommand
	{
		#region Constructor
		/// <summary>
		/// Creates a new instance of <see cref="ParameterizedAnyCommand"/>.
		/// </summary>
		public ParameterizedAnyCommand() : base() { }

		/// <summary>
		/// Creates a new instance of <see cref="ParameterizedAnyCommand"/>.
		/// </summary>
		/// <param name="action">The action to be invoked.</param>
		public ParameterizedAnyCommand(Action<object> action) : base(action) { }
		...
		public ParameterizedAnyCommand(Action<object> action, Func<object, bool> condition) : base(action, condition) { }

		/// <summary>
		/// Creates a new instance of <see cref="ParameterizedAnyCommand"/>.
		/// </summary>
		/// <param name="actions">The actions to be invoked.</param>
		public ParameterizedAnyCommand(params Action<object>[] actions) : base(actions) { }

		/// <summary>
		/// Creates a new instance of <see cref="ParameterizedAnyCommand"/>.
		/// </summary>
		/// <param name="action">The action to be invoked.</param>
		public ParameterizedAnyCommand(ParameterizedCommandAction action) : base(action) { }

		/// <summary>
		/// Creates a new instance of <see cref="ParameterizedAnyCommand"/>.
		/// </summary>
		/// <param name="actions">The actions to be invoked.</param>
		public ParameterizedAnyCommand(params ParameterizedCommandAction[] actions) : base(actions) { }
		#endregion
		...
		public override bool CanExecute(object parameter)
		{
			...
			{
				return Actions.Any(action => action.Condition(parameter));
			}
			else return false;
		}
		#endregion
